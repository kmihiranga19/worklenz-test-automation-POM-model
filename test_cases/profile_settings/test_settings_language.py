...
from page_objects.ProfileSettings.SettingsLanguage import SettingsLanguage
import time
...
class TestSettingsLanguage:
    ...
    def test_settings_language(self, setup):
        self.browser = setup
        ...
        time.sleep(3)
        self.slr = SettingsLanguage(self.browser)
        time.sleep(3)
        self.slr.clickLanguageRegion()
        time.sleep(3)
        self.slr.clickLanguageSelect()
        time.sleep(3)
        self.slr.clickEnglish()
        time.sleep(3)
        self.slr.clickTimeZone()
        time.sleep(3)
        self.slr.selectTimeZone()
        time.sleep(3)
        self.slr.saveBtn()
        time.sleep(5)
