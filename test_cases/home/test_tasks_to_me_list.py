...
class TestTasksToMeList:
    ...
    def test_tasks_to_me_list(self, setup):
        self.browser = setup
        ...
        time.sleep(3)
        self.ht.enterTask(self.taskNameTo)
        time.sleep(3)
        self.ht.selectToday()
        time.sleep(3)
        self.ht.selectProject()
        time.sleep(3)
        self.ht.enterTask(self.taskName2To)
        time.sleep(3)
        self.ht.selectTomorrow()
        time.sleep(3)
        self.ht.selectProject()
        time.sleep(3)
        self.ht.enterTask(self.taskName3to)
        time.sleep(3)
        self.ht.selectNextWeek()
        time.sleep(3)
        self.ht.selectProject()
        time.sleep(3)
        self.ht.enterTask(self.taskName4To)
        time.sleep(3)
        self.ht.selectNextMonth()
        time.sleep(3)
        self.ht.selectProject()
        time.sleep(3)
        self.ht.enterTask(self.taskName5To)
        time.sleep(3)
